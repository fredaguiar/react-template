module.exports = {
  ...
  sso: {
    enabled: true,
    env: 'pt148',
    callback: 'https://portalstartertemplateui-staging-ui-portals.paas-app-west-np.tsl.enterprise.com/RAPiD3/login/callback',
    issuer: 'https://portalstartertemplateui-staging-ui-portals.paas-app-west-np.tsl.enterprise.com/RAPiD3',
  },
  permit: {
    env: 'dv',
    appid: 'nodejs_poc',
