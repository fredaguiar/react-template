...
try {
  ...
  //     cloud: 'openshift',
  //     containers: [
  //       containerTemplate(name: 'jnlp', image: 'repomgr.tsl.enterprise.com:19901/enterprise/jenkins-slave-image-mgmt:3.6.0')
  //     ],
  //     annotations: [
  ...
  //               docker://docker-registry-default.paas-app-west.tsl.enterprise.com:443/portals/portalstartertemplate-ui --src-creds=builder:${saTokenNp} \
